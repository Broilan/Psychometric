import { ConfidenceInterval, ItemDefinition, ScaleDefinition, ScoreResult, SubscaleScoreResult } from '../schemas';
...
export declare function scoreConfidenceInterval(observedScore: number, sem: number, level?: number): ConfidenceInterval;
export declare function scoreSubscales(definition: ScaleDefinition<number>, responses: Readonly<Record<string, number | null | undefined>>, options?: ScaleScoringOptions): SubscaleScoreResult[];
...
export declare function scoreLikertScale(definition: ScaleDefinition<number>, responses: Readonly<Record<string, number | null | undefined>>, options?: ScaleScoringOptions): ScoreResult;
export declare function scoreBattery(definitions: readonly ScaleDefinition<number>[], responsesByScale: Readonly<Record<string, Readonly<Record<string, number | null | undefined>>>>, options?: ScaleScoringOptions): ScoreResult[];
